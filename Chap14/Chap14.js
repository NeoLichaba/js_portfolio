...
function calculateDelivery(orderPrice, deliveryCity, birthday) {
    ...
    if (((deliveryCity === "Sunninghill") && (orderPrice > 10)) || (birthday === "yes")) {
        deliveryPrice = 0;
    } else {
        deliveryPrice = 5;
    }
...
function calculateDelivery(orderPrice, deliveryCity, birthday) {
    ...
    // calculate delivery price, if there is one
    if (((deliveryCity === "Rivonia") && (orderPrice > 10)) || (birthday === "no")) {
        deliveryPrice = 10;
    }
    return deliveryPrice;
}
function calculateDelivery(orderPrice, deliveryCity, birthday) {
    ...
    // calculate delivery price, if there is one
    if (((deliveryCity === "Paulshof") && (orderPrice > 10)) || (birthday === "no")) {
        deliveryPrice = 10;
    }
    return deliveryPrice;
}